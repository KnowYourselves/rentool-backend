...
urlpatterns = [
    ...
    path("tool-listings/mine/", views.MyPublishedToolListingList.as_view()),
    path("tool-listings/my-rented-tools/", views.MyRentedToolListingList.as_view()),
    path("tool-listings/my-rentals/", views.MyRentalsList.as_view()),
